...
import { useImportCsvLinear } from '@/lib/hooks/use-advanced-features';
...
interface LinearCsvImportDialogProps {
  trigger?: React.ReactNode;
}

export function LinearCsvImportDialog({ trigger }: LinearCsvImportDialogProps) {
  ...
  const importMutation = useImportCsvLinear();
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          <DialogTitle>Import from Linear CSV</DialogTitle>
          <DialogDescription>
            Upload a Linear-exported CSV file to create a new project with tasks and metadata.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            <Label htmlFor="linear-csv-file">CSV File</Label>
          ...
          <div className="grid gap-3">
            ...
            <RadioGroup value={importMode} onValueChange={(value) => setImportMode(value as 'new' | 'existing')}>
              <div className="flex items-center space-x-2 p-3 border rounded-md hover:bg-muted/50 cursor-pointer">
                ...
                <Label htmlFor="new-project" className="flex-1 cursor-pointer">
              ...
              <div className="flex items-center space-x-2 p-3 border rounded-md hover:bg-muted/50 cursor-pointer">
                ...
                <Label htmlFor="existing-project" className="flex-1 cursor-pointer">
          ...
          {importMode === 'new' && (
            <div className="grid gap-2">
              <Label htmlFor="linear-project-name">New Project Name</Label>
              <Input
                id="linear-project-name"
              ...
              {newProjectName && projects?.some(p => p.name === newProjectName) && (
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="linear-overwrite" className="text-sm font-normal cursor-pointer">
