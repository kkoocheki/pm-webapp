...
info
You can also style cells of the timescale: [Styling cells](/react/gantt/guides/configuration/configure_scales/#styling-cells)

## Disabling fonts[​](#disabling-fonts)
...
PreviousLocalizationNextBackend
- [Theme settings](#theme-settings)
- [Applying a theme](#applying-a-theme)
- [Customizing theme settings](#customizing-theme-settings)
- [Disabling fonts](#disabling-fonts)
